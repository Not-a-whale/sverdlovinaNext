...
const MainForm = () => {
  ...
  return (
    <div className="w-1/2 ml-auto flex flex-col items-center bg-white/20 backdrop-blur-[120px] rounded-[13px]">
        ...
        <Controller
          ...
          render={({ field }) => (
            <input
              ...
              className="input input-bordered input-info bg-white/80 w-full max-w-xs xl:max-w-[90%]"
            />
          )}
        />
        <Controller
